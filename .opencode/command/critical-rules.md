...
```typescript
// ✅ CORRECT
import * as schema from "@your-project/db/schema";
import { ZPostInsert, type PostSelect } from "@your-project/db/dtos/validation";

// ❌ WRONG
import * as schema from "@your-project/db/schema/index";
import * as schema from "@your-project/db/src/schema/posts";
```
...
| Imports   | `@your-project/db/schema`    | `.../db/schema/index`                  |
