...
- Uses generic placeholders (`@your-project/db`, `resources`, etc.)
...
- Changed `@hypermile.club/*` → `@your-project/*`
...
- `@your-project/db` → `@acme/database`
- `@your-project/ui` → `@acme/ui`
