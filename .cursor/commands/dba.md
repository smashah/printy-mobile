---
TASK: Act as a Database Architect. Analyze the entirety of the Product Requirements Document (PRD) located at **'${PRD_PATH}'**. Your goal is to infer the core data models and relationships required to support the functionality described in the document.

INPUT FILE:
- **PRD Content:** Read and analyze the complete textual content of the file at **${PRD_PATH}**.
...
OUTPUT FORMAT:
Write the complete database schema outline directly to **${OUTPUT_PATH}** using the following Markdown structure. Do not include any text outside of this final file content.
